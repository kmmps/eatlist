...
const ThumbUpIc   = ({ s=15, col='#8D9091' }) => <Ic s={s}><path d="M14 9V5a3 3 0 00-3-3l-4 9v11h11.28a2 2 0 002-1.7l1.38-9a2 2 0 00-2-2.3H14z" stroke={col} strokeWidth="1.5"/><path d="M7 22H4a2 2 0 01-2-2v-7a2 2 0 012-2h3" stroke={col} strokeWidth="1.5"/></Ic>;
const ThumbDownIc = ({ s=15, col='#8D9091' }) => <Ic s={s}><path d="M10 15v4a3 3 0 003 3l4-9V2H5.72a2 2 0 00-2 1.7l-1.38 9a2 2 0 002 2.3H10z" stroke={col} strokeWidth="1.5"/><path d="M17 2h2.67A2.31 2.31 0 0122 4v7a2.31 2.31 0 01-2.33 2H17" stroke={col} strokeWidth="1.5"/></Ic>;
