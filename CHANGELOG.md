...
**Tasks concluídas:** 1.2, 1.1, 1.5, 1.4  
...
- **1.3 — Form validation on Register:** Não implementada — voltou ao backlog para ser resolvida de outra forma.
